...
## Clock Signal
set_property -dict { PACKAGE_PIN H16    IOSTANDARD LVCMOS33 } [get_ports { device_clk }]; #IO_L13P_T2_MRCC_35 Sch=SYSCLK
...
## Module 1
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { TX_node_1 }]; #IO_L23N_T3_34           Sch=CK_IO12
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { RX_node_1 }]; #IO_L23P_T3_34           Sch=CK_IO13

## ChipKit Inner Digital Header
#set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { ck_io26 }]; #IO_L19N_T3_VREF_13  Sch=CK_IO26
## Module 3
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { AUX_3 }]; #IO_L6N_T0_VREF_13   Sch=CK_IO27
...
## Module 2
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { AUX_2 }]; #IO_L15P_T2_DQS_13   Sch=CK_IO32
...
## Module 1
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33 } [get_ports { AUX_1 }]; #IO_L13P_T2_MRCC_13  Sch=cCK_IO37
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { TX_mcu_1 }]; #IO_L15N_T2_DQS_13   Sch=CK_IO38
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { RX_mcu_1 }]; #IO_L14N_T2_SRCC_13  Sch=CK_IO39
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { M1_1 }]; #IO_L16N_T2_13       Sch=CK_IO40
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { M0_1 }]; #IO_L14P_T2_SRCC_13  Sch=CK_IO41
